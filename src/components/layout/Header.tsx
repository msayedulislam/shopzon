    ...
    <>
      <>
        <header className="flex flex-col w-full relative z-[50]">
          ...
          <div className="bg-gradient-to-r from-primary via-primary/90 to-primary text-primary-foreground relative overflow-hidden py-2.5">
            {/* Animated Shimmer */}
          ...
          {/* Main Header - Sticky */}
          <div className={`sticky top-0 z-[50] glass-strong border-b border-white/5 backdrop-blur-xl transition-all duration-300 ${!isAtTop ? 'shadow-xl bg-background/98 dark:bg-background/98' : ''
            }`}>
          ...
          {/* Categories Navigation - Normal flow, scrolls away */}
          <nav className="hidden lg:block glass border-b border-white/5 overflow-hidden">
        ...
        <button
          ...
          className={`fixed bottom-6 right-6 z-50 h-12 w-12 rounded-full bg-gradient-to-br from-primary to-primary/80 text-primary-foreground shadow-glow flex items-center justify-center transition-all duration-500 hover:scale-110 ${!isAtTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'
            }`}
